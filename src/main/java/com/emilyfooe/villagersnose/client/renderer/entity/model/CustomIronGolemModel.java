...
@OnlyIn(Dist.CLIENT)
public class CustomIronGolemModel<T extends IronGolemEntity> extends SegmentedModel<T> {
...
//        this.nose.setPos(0.0F, -7.0F, -2.0F);
        this.nose.texOffs(24, 0).addBox(-1.0F, -5.0F, -7.5F, 2.0F, 4.0F, 2.0F, 0.0F);
