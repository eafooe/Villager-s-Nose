...
import com.emilyfooe.villagersnose.client.renderer.entity.layers.CustomIronGolemCracksLayer;
import com.emilyfooe.villagersnose.client.renderer.entity.layers.CustomIronGolemFlowerLayer;
...
@OnlyIn(Dist.CLIENT)
public class CustomIronGolemRenderer extends MobRenderer<IronGolemEntity, CustomIronGolemModel<IronGolemEntity>> {
    private static final ResourceLocation GOLEM_LOCATION = new ResourceLocation("textures/entity/iron_golem/iron_golem.png");

    public CustomIronGolemRenderer(EntityRendererManager p_i46133_1_) {
        super(p_i46133_1_, new CustomIronGolemModel<>(), 0.7F);
        this.addLayer(new CustomIronGolemCracksLayer(this));
        this.addLayer(new CustomIronGolemFlowerLayer(this));
    }
