...
@OnlyIn(Dist.CLIENT)
public class CustomIronGolemFlowerLayer extends LayerRenderer<IronGolemEntity, CustomIronGolemModel<IronGolemEntity>> {
    public CustomIronGolemFlowerLayer(IEntityRenderer<IronGolemEntity, CustomIronGolemModel<IronGolemEntity>> p_i50935_1_) {
        super(p_i50935_1_);
    }
