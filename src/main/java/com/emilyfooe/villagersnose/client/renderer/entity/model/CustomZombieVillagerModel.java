...
@OnlyIn(Dist.CLIENT)
public class CustomZombieVillagerModel<T extends ZombieEntity> extends BipedModel<T> implements IHeadToggle {
    private ModelRenderer hatRim;
    public  ModelRenderer nose;

    public CustomZombieVillagerModel(float p_i51058_1_, boolean p_i51058_2_) {
        ...
        if (p_i51058_2_) {
            ...
            this.nose.texOffs(24, 0).addBox(-1.0F, -1.0F, -6.0F, 2.0F, 4.0F, 2.0F, p_i51058_1_);
