...
@OnlyIn(Dist.CLIENT)
public class CustomIronGolemCracksLayer extends LayerRenderer<IronGolemEntity, CustomIronGolemModel<IronGolemEntity>> {
    ...
    public CustomIronGolemCracksLayer(IEntityRenderer<IronGolemEntity, CustomIronGolemModel<IronGolemEntity>> p_i226040_1_) {
        super(p_i226040_1_);
    }
